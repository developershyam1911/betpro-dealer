...
<head>
    ...
    <title>Admin Dashboard || Feedshack</title>
    <meta
                  ...
                  <ul class="nav nav-collapse">
                    <li>
                      <a href="{{route('category.create')}}">
                        <span class="sub-item">Create Game</span>
                      </a>
                    </li>
                    <li>
                      <a href="{{route('category.list')}}">
                        <span class="sub-item">Game List</span>
                      </a>
                    </li>
                  </ul>
                </div>
                  ...
                  <ul class="nav nav-collapse">
                    <li>
                      <a href="{{route('client.create')}}">
                        <span class="sub-item">Create Client</span>
                      </a>
                    </li>
                    <li>
                      <a href="{{route('client.read')}}">
      ...
      <div class="main-panel">
        ...
        <footer class="footer">
          <div class="container-fluid d-flex justify-content-between">
            <div class="copyright">
              Itgenix Softech Solutions, Made with <i class="fa fa-heart heart text-danger"></i> in India
            </div>
            {{-- <div>
              Distributed by
...
<!-- Mirrored from themewagon.github.io/kaiadmin-lite/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 01 Oct 2024 12:40:07 GMT -->
</html>
